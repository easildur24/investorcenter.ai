...
function AlertsPageContent() {
  ...
  const handleCreateClick = () => {
    if (
      ...
      limits.current_alert_rules >= limits.max_alert_rules
    ) {
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between mb-4">
            <div>
              ...
              <p className="text-ic-text-dim">Manage your price, volume, and event alerts</p>
            </div>
            <button
              ...
              <div className="flex items-center gap-4">
                <div className="text-sm">
                  ...
                  <span className="text-ic-text-primary font-semibold">
                    {limits.current_alert_rules} /{' '}
                    {limits.max_alert_rules === -1 ? '∞' : limits.max_alert_rules}
                  </span>
                </div>
                {limits.max_alert_rules !== -1 &&
                  limits.current_alert_rules >= limits.max_alert_rules * 0.8 && (
            ...
            {filteredAlerts.length === 0 ? (
              <div className="text-center py-20">
                <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-slate-800 mb-4">
                  <svg
                    className="w-8 h-8 text-ic-text-muted"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                  >
                ...
                <p className="text-ic-text-dim mb-6">
                  Create your first alert to get notified about price movements, volume spikes, or
                  market events
                </p>
                <button
                  onClick={handleCreateClick}
