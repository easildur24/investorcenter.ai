...
export const themeColors = {
  dark: {
    ...
    textDim: '#71717A',
    // Hero section
    heroBg: 'linear-gradient(135deg, #1E40AF 0%, #3B82F6 50%, #0EA5E9 100%)',
    heroTextAccent: '#BAE6FD',
    heroTextBody: 'rgba(255, 255, 255, 0.8)',
    // Card shadows
    shadowCard: 'none',
    blurCircle: 'rgba(255, 255, 255, 0.1)',
  },
  light: {
    // Slate palette (blue-tinted, not gray Zinc)
    bgPrimary: '#FFFFFF',
    bgSecondary: '#F8FAFC',
    bgTertiary: '#F1F5F9',
    surface: '#FFFFFF',
    ...
    textDim: '#94A3B8',
    // Hero section
    heroBg: 'linear-gradient(180deg, #EFF6FF 0%, #DBEAFE 50%, #BFDBFE 100%)',
    heroTextAccent: '#1D4ED8',
    heroTextBody: '#475569',
    // Card shadows
    shadowCard: '0 4px 20px rgba(0, 0, 0, 0.06)',
    blurCircle: 'rgba(59, 130, 246, 0.1)',
  },
  accent: {
    blue: '#3B82F6',
    blueHover: '#2563EB',
