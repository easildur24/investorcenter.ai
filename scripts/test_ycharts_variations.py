...
def test_alternative_endpoints():
    ...
    endpoints = [
        ...
        ("https://api.ycharts.com/v1/securities/AAPL/metrics", {'metrics': '1day_return,52_week_high'}),
        ("https://api.ycharts.com/v1/securities/AAPL", {'metrics': '1day_return,52_week_high'}),
        ("https://api.ycharts.com/v1/companies/AAPL/series", {'metrics': '1day_return,52_week_high'}),
        ("https://api.ycharts.com/v1/data", {'security_id': 'AAPL', 'metrics': '1day_return,52_week_high'}),
        
        # Query-based endpoints
        ("https://api.ycharts.com/v1/query", {'security': 'AAPL', 'metrics': '1day_return,52_week_high'}),
        ("https://api.ycharts.com/v1/timeseries", {'symbol': 'AAPL', 'metrics': '1day_return,52_week_high'}),
        
        # GraphQL style
        ("https://api.ycharts.com/graphql", {'query': '{ security(id: "AAPL") { metrics(ids: ["1day_return", "52_week_high"]) } }'}),
    ]
